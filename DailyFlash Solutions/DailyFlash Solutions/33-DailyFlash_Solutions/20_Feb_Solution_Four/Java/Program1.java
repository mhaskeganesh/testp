...
//User defined class to Find Hexadecimal Value of Digits of the Number
class Hexadecimal {
	...
	public static void main(String[] args) throws IOException {
		...
		temp = rev;
		//While loop to Print Hexadecimal value of each Digit
		while(temp > 0){

			System.out.println("HexaDecimal Value of "+(temp%10)+" : "+Integer.toHexString(temp%10));
			temp/=10;
		}
