...
Program0 -- Program0 -- Write a Program to print sum of an an Arithmetic Progression (A.P.) series. Take Starting element, Total count of elements in A.P. & the Common Difference from user.
...
for x in range(count) :
    ...
    apsum = apsum + (start + (x*diff))
    print(start + (x*diff),end=" ")

print()
print("The Sum of the AP is ",apsum)
