...
//User defined class to Print Quotient of division of each digit from Number
class Quotient {
	...
	public static void main(String[] args) throws IOException {
		...
		while(temp > 0){
			...
			System.out.println("The Quotient of Division "+num_input_1+"/"+(temp%10)+" = "+(num_input_1/(temp%10)));
			temp/=10;
		}
	}
}
